...
```ts
import { DuckDBConnection } from '@haybarn/node-api';
...
```ts
import { DuckDBInstanceCache } from '@haybarn/node-api';
...
```ts
import { DuckDBTypeId } from '@haybarn/node-api';
...
```ts
import { DuckDBPendingResultState } from '@haybarn/node-api';
