# Haybarn Node Bindings: Linux arm64 musl

Binaries supporting [Haybarn](https://github.com/Query-farm-haybarn/haybarn) [Node](https://nodejs.org/) bindings to the [DuckDB C API](https://duckdb.org/docs/api/c/overview) for Linux arm64 musl.
